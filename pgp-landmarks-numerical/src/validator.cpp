...
int main(  int argc, const char* argv[] ){
    if( argc < 3 ){
        ...
        cout << "[INFO] The domain file must be domain.pddl with all instances numbered from 1.txt to [n].txt" << endl;
        return -1;
    }
    ...
    vector< ProgramState* > vps = p->run_validation( gpp, plans, infinite_detection, false );
