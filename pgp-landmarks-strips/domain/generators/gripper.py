...
def main():
	...
	str_domain += "grippernew:var_type\n"
	str_domain += "at-robby(room):pred_type\n"
	str_domain += "at(ball,room):pred_type\n"
	str_domain += "free(grippernew):pred_type\n"
	str_domain += "carry(ball,grippernew):pred_type\n"
	str_domain += "r1:room\n"
	str_domain += "r2:room\n"
	str_domain += "b1:ball\n"
	str_domain += "g1:grippernew\n"
	...
	str_domain += "\nACTION: pick(b:ball,r:room,g:grippernew)\n"
	str_domain += "TYPE: memory\n"
	str_domain += "PRECONDITIONS:\n"
	str_domain += "( at(b,r) = 1 )\n"
	...
	str_domain += "ACTION: drop(b:ball,r:room,g:grippernew)\n"
	str_domain += "TYPE: memory\n"
	str_domain += "PRECONDITIONS:\n"
	str_domain += "( carry(b,g) = 1 )\n"
	str_domain += "( at-robby(r) = 1 )\n"
	...
	f_domain=open( out_folder + "domains.txt", "w" )
	...
	for i in range(from_nth,to_nth+1):
		...
		str_problem += "left:grippernew\n"
		str_problem += "right:grippernew\n"
