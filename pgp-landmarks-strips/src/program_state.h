...
// chao edit
//    const vector< int > asVector() const{
//        vector< int > res( 1, _line );
//        for( auto & v : _state->getTypedPointers() ){
//            for (auto pointers: v){
...
//        }
//
//        for( auto & pred_regs : _state->getTypedRegisters() ) {
//            for( auto sreg : pred_regs) {
//                // add only strictly positive valued predicates
//                if( sreg.second == 0 )
//                    continue;
//                for (auto location :sreg.first){
//                    res.push_back( location );
//                }
//                res.push_back( sreg.second );
//            }
//        }
//
//        return std::move(res);
